...
<body>
    ...
    <div class="container-fluid">
                ...
                <div class="card h-100 border-primary">
                    <div class="card-body">
                        ...
                        <p class="card-text text-success mb-0">
                            ...
                            <?php echo number_format($active_stores); ?> Active Stores
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card h-100 border-success">
                    <div class="card-body">
                        ...
                        <p class="card-text text-success mb-0">
                            <i class="fas fa-check-circle"></i>
                            <?php echo number_format($active_customers); ?> Active Customers
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card h-100 border-info">
                    <div class="card-body">
                        ...
                        <p class="card-text text-success mb-0">
                            <i class="fas fa-check-circle"></i>
                            <?php echo number_format($completed_orders); ?> Completed Orders
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card h-100 border-warning">
                    <div class="card-body">
                        ...
                        ?>
                        <h3 class="mb-2"><?php echo number_format($total_sales, 2); ?> SAR</h3>
                        <p class="card-text text-success mb-0">
        ...
        <!-- Latest Registered Stores -->
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Latest Registered Stores</h5>
                    ...
                    <tbody>
                        ...
                        if ($latest_stores_result) {
                            while ($row = $latest_stores_result->fetch_assoc()) {
                                // Make sure to clean data before displaying it
                        ...
                        foreach ($latest_stores as $store):
                            ...
                            $status_text = $store['status'] === 'active' ? 'Active' : 'Under Review';
                        ?>
                        <tr>
                            <td>
