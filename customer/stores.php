...
/**
 * Stores Listing Page
 * Displays all available stores with filtering and search capabilities
 */
...
// Set page title
$page_title = "Browse Stores";
$root_path = "../";

// Set number of stores per page
$stores_per_page = 12;
...
// Build stores query using the same method as in index.php
$stores_sql = "SELECT 
    s.*, 
...
// Comprehensive search in name, description, city and products
if (isset($_GET['search']) && !empty($_GET['search'])) {
    $search = $_GET['search'];
    $search_params = [];
    
    // Add search conditions for all important fields
...
// No filtering by city or category after modification
...
// Calculate total number of stores for pagination
...
if ($count_stmt === false) {
    die('Error preparing store count query: ' . $conn->error);
}

// Bind only search and filter parameters (without limit and offset parameters)
...
if (!$count_stmt->execute()) {
    die('Error executing store count query: ' . $count_stmt->error);
}
...
// Convert store results to array
$stores = [];
while ($store = $stores_result->fetch_assoc()) {
    $stores[] = $store;
}

// Query to fetch available categories for stores
...
// Query to fetch available cities
...
// Include dark header file as in index.php
$root_path = '../';
...
<div class="container mt-4">
    ...
    <div class="stores-header text-center p-4">
        <h1 class="stores-title">Browse Stores</h1>
        <p class="stores-description">Discover a diverse collection of premium stores and shop with confidence and security</p>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-10 mb-3">
                        <div class="input-group" style="border: 2px solid #FF7A00; border-radius: 8px; overflow: hidden;">
                            ...
                            <input type="text" class="form-control" name="search" style="border: none; box-shadow: none;" placeholder="Search for a store (includes name and description)" value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
                            <button type="submit" class="btn" style="background-color: #FF7A00; color: white; border: none;">Search</button>
                        </div>
        ...
        <div class="col-md-12">
                        ...
                        <div class="col-md-3 col-sm-6 mb-4">
                            <div class="store-card">
                                ...
                                <div class="store-badge">
                                    <i class="bi bi-lightning-fill"></i> <?php echo $store['offers_count']; ?> Offers
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="store-card-body">
                                    ...
                                    <p class="store-description"><?php echo !empty($store['description']) ? $store['description'] : 'No description available for this store'; ?></p>
                                    <div class="store-meta">
                                        ...
                                        <div class="meta-item">
                                            ...
                                            <span><?php echo $store['products_count'] ?? 0; ?> products</span>
                                        </div>
                                        <div class="meta-item">
            ...
            <?php else: ?>
                <div class="no-stores">
                    ...
                    <h3 class="no-stores-text">No stores currently available</h3>
                    <p>Try changing your search criteria</p>
                    <a href="stores.php" class="btn" style="background-color: #FF7A00; color: white; border: none;">View All Stores</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
